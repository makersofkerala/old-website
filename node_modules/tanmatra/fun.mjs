...
const selectKeys = (v,keys) => reduce((i,x) => (v[x] != null) ? merge(i,{[x]: v[x]}) : i,{},keys);
...
if(typeof module != "undefined" && module.exports) {
    module.exports = {merge, assoc, dissoc, update, renameKeys, transpose, repeat, range, steps, reduce, map, mapidx, kvmap, kvfilter, mapKeys, mapVals, kvreduce, partition, rollover, grid, mapcat, objEq, eq, diffArrs, diffVals, diffObjs, diff, isArr, head, tail, isEmpty, log, normalizeArrs, isObj, partial, identity, find, random, randomVec, randomItem, vAdd, vSub, vMul, vDiv, vMag, vRot, vUnit, isAny, isEvery, notEmpty, selectKeys, concat};
};
