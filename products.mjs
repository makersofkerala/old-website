...
const page = products => ["div.product-section",
                         ["div.logo products-section-logo",["img", {alt: "Makers of Kerala Logo", src: "/logo2.svg"}],
												...
												["div.product-name-details",["div.product-image-container", ["img", {src: "/product-logo.png"}]],
								...
								["footer",
								["section.sign-up-section",["div.section-header footer-section-header", "sign up"], ["p.sign-up-helper", "Get the latest news from Makers of Kerala."],["div.signup-button-container",["a.whatsapp-group signup-button", {href:"https://chat.whatsapp.com/HufqsS5FLgJ9DHRRNSUfrc"},"Join our Whatsapp Group"],["a.telegram-broadcast signup-button", {href:"https://t.me/makersofkerala"},"Join our Telegram Broadcast"],],],
								["section.follow-us-section",["div.section-header footer-section-header", "Follow us on"],
								["div.social-media-icons",["a.social-icon", {href:"https://instagram.com/makersofkerala"}, ["img", {src: "/instagram.svg"}]],
